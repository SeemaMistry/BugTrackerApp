...
import stylesCss from 'themes/BugTrackerApp/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_BugTrackerApp_componentCss']) {
    
    document['_vaadintheme_BugTrackerApp_componentCss'] = true;
  }
